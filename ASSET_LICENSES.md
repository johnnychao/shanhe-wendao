...
建築、亭橋、地形配置、水道、光霧、介面及教學故事由本專案製作；自然模型與人物基底仍依上述來源追溯。上段早期視覺資產保留追溯；現行採同系列卡通人物與師大校園，不宣稱商業大型遊戲品質。

## 教材與程式依賴

v0.7新增W9–16的60人活動、48人服務台、160列八候選題資料、64份材料及16段故事均為原創合成內容。參考SPSS Practical Guide 22第7／12／13／15／16／17／18章、IBM22指令與算法，以及Coding with AI第8／9章查證流程；未散布原書或供應商檔案。12份starter與3個教學分支已由本機SPSS22執行並獨立核對。UG W14原版有刻意設計的加法錯誤，學生需修復並留前後證據；EFA及合成外部指標不代表量表效度或公平性已驗證。
